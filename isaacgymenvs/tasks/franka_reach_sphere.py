...
class FrankaReachSphere(VecTask):
    ...
    # def draw_debug_marker(self, position,  marker_type=gymapi.MARKER_SPHERE, scale=(0.1, 0.1, 0.1), color=(1.0, 0.0, 0.0)):
    #     """
    #     Draws a debug marker at the specified position.
    #
    #     Parameters:
    #     - position: gymapi.Vec3, the position where the marker should be placed.
    #     - color: gymapi.Vec3, the color of the marker (RGB, values between 0 and 1).
    #     - size: float, the size of the marker.
    #     """
    #     """
    #     Adds a marker at a specified position in the environment.
    #
    #     Parameters:
    #     - position: tuple or list, the (x, y, z) position where the marker should be placed.
    #     - marker_type: gymapi.MarkerType, the type of the marker (default is SPHERE).
    #     - scale: tuple or list, the scale of the marker (default is (0.1, 0.1, 0.1)).
    #     - color: tuple or list, the color of the marker in RGB (default is (1.0, 0.0, 0.0)).
    #     """
    #     axes_geom = gymutil.AxesGeometry(0.1)
    #     # Create an wireframe sphere
    #     sphere_rot = gymapi.Quat.from_euler_zyx(0.5 * 3.1415926, 0, 0)
